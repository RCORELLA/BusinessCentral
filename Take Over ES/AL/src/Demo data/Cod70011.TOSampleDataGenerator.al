codeunit 70011 "TO - SampleDataGenerator"
{
    ...
    var
        ...
        //RCB TaxGroupCode: Record "Tax Group";
        ItemVAT: Record "VAT Product Posting Group";
    begin
        InventoryGroup.FindFirst();
        //RCB TaxGroupCode.FindFirst();
        ItemVAT.Get('IVA21');
        //RCB GenProdPostingGroup.Get('RETAIL');
        GenProdPostingGroup.Get('MERCADERÍA');
        ...
        if itemRecord.Get(itemNumber) then begin
            ...
            //RCB ItemRecord.Validate("Tax Group Code", TaxGroupCode.Code);
            ItemRecord.Validate("VAT Prod. Posting Group", ItemVAT.Code);
    ...
    var
        ...
        //rcb
        VATGroup: Record "VAT Business Posting Group";
    begin
        CustomerPostingGroup.FindFirst();
        // RCB TaxAreaCode.FindFirst();
        VATGroup.FindFirst();
        GenBusPostingGroup.FindFirst();
        PaymentTerms.Get('CON');
        ...
        // RCB CustomerRecord.Validate("Tax Area Code", TaxAreaCode.Code);
        CustomerRecord.Validate("VAT Bus. Posting Group", VATGroup.Code);
    ...
    begin
        ...
        //RCB ItemUnitOfMeasure.SetRange(Code, 'PCS');
        ItemUnitOfMeasure.SetRange(Code, 'UDS');
        ...
        ItemRecord.validate("Base Unit of Measure", 'UDS');
        ItemRecord.Modify(true);
    end;
